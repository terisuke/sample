...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 3490103065490609479),
      name: 'Counter',
      lastPropertyId: const obx_int.IdUid(3, 8587804474473043286),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 6035900862786608394),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 4587340748490707697),
            name: 'title',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 8587804474473043286),
            name: 'count',
            type: 6,
            flags: 0)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 3490103065490609479),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    Counter: obx_int.EntityDefinition<Counter>(
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final object = Counter(title: titleParam, count: countParam)
